Pod::Spec.new do |s|
    ...
    s.dependency 'LayoutAnchor', :git => 'https://github.com/frankyliu-maxwin/LayoutAnchor', :tag => '4.2.0' #4.2.0
    s.dependency 'CStructDecodable', :git => 'https://github.com/frankyliu-maxwin/CStructDecodable', :tag =>'4.0.1' #4.0.1
    s.dependency 'YumeAlamofire/Rx', :git => 'https://github.com/frankyliu-maxwin/YumeAlamofire', :tag => '5.0.5'
